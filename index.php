    ...
    <div class="main-container w3-card">
        ...
        <header class="bgimg-1 w3-display-container  w3-grayscale-min" id="home">
            <div class=" w3-text-white w3-display-left " style="padding:48px">
                <span class="w3-xlarge " style="color: blue;"><b>DO RESPONSIVE <br> WEB DESIGN</b></span><br>
                <span class="w3-large">
                ...
                <p><a href="about.html"
                        class="w3-button btn-special w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Learn
